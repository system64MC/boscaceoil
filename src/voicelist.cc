...
namespace bosca
{
	...
	void voicelistclass::fixlengths() {
	...
	void voicelistclass::create(std::string cat, std::string t1, std::string t2, int pal, int midimapping) {
	...
	void voicelistclass::makesublist(std::string cat) {
		sublistsize = 0;
		for (int i = 0; i < listsize; i++) {
			if (category[i] == cat) {
	...
	void voicelistclass::add(std::string t1, std::string t2, int pal) {
	...
	int voicelistclass::getfirst(std::string cat) {
		for (int i = 0; i < listsize; i++) {
	...
	int voicelistclass::getlast(std::string cat) {
	...
	int voicelistclass::getvoice(std::string n) {
		for (int i = 0; i < listsize; i++) {
	...
	int voicelistclass::getnext(int current) {
	...
	int voicelistclass::getprevious(int current) {
